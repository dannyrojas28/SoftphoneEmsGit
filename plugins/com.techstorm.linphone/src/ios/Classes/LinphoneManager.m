...
#pragma mark - Dtmf Received Functions

static void linphone_iphone_dtmf_received_changed(LinphoneCore* lc, LinphoneCall *call, int dtmf) {
    [(__bridge LinphoneManager *)linphone_core_get_user_data(lc) onDtmfReceived:lc call:call dtmf:dtmf];
}
...
- (void)onDtmfReceived:(LinphoneCore *)lc call:(LinphoneCall *)call dtmf:(int)dtmf {
    ...
    NSDictionary *dict = @{
                           @"call" : [NSValue valueWithPointer:call],
                           @"dtmf" : [NSNumber numberWithInt:dtmf]
                           };
...
#pragma deploymate pop
	...
	if ([UIApplication sharedApplication].applicationState == UIApplicationStateBackground) {
		...
		if (notif) {
			NSString *chat = [LinphoneManager TextMessageForChat:msg];
...
static LinphoneCoreVTable linphonec_vtable = {
	...
	.dtmf_received = linphone_iphone_dtmf_received_changed,
