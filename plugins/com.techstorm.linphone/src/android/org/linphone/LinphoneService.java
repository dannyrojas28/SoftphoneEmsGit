...
//	private boolean mTestDelayElapsed; // add a timer for testing
	...
	public void onCreate() {
		...
		mNotif = Compatibility.createNotification(this, mNotificationTitle, "", 0, R.drawable.icon, bm, mNotifContentIntent, true,notifcationsPriority);
...
//			inconId = R.drawable.topbar_videocall_notification;
	...
	public synchronized void sendNotification(int level, String text) {
		...
		mNotif = Compatibility.createNotification(this, mNotificationTitle, text, R.drawable.icon, 0, bm, mNotifContentIntent, true,notifcationsPriority);
